...
OpGenerator affineApplyGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &region) {
    ...
    auto ret = builder.create<mlir::affine::AffineApplyOp>(loc, map, operands);
  ...
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto blockBuilder = [&](OpBuilder &b, Location loc,
      ...
      if (hasIterArg) {
        ...
        builder.create<mlir::affine::AffineYieldOp>(loc, ret.val);
      } else {
        builder.create<mlir::affine::AffineYieldOp>(loc);
      }
    };
    if (hasIterArg) {
      auto res = builder.create<mlir::affine::AffineForOp>(
      ...
      return builder
          .create<mlir::affine::AffineForOp>(loc, lowerBound, upperBound, step,
...
OpGenerator affineIfGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto ifOp = builder.create<mlir::affine::AffineIfOp>(loc, resultTypes, set,
                                                         args, withElseRegion);
    ...
    auto blockBuilder = [&]() {
      ...
      if (hasResult) {
        ...
        builder.create<mlir::affine::AffineYieldOp>(loc, ValueRange(ret.val));
      }
    };
...
OpGenerator affineLoadGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    assert(memref.val);
    auto res = builder.create<mlir::affine::AffineLoadOp>(loc, memref.val,
                                                          ValueRange(indices));
...
OpGenerator affineStoreGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    return builder
        .create<mlir::affine::AffineStoreOp>(loc, elem2Store.val, memref.val,
                                             ValueRange(indices))
        .getOperation();
  };
}
...
OpGenerator affineMaxGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto index =
        builder.create<mlir::affine::AffineMaxOp>(loc, map, mapOperands);
...
OpGenerator affineMinGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto index =
        builder.create<mlir::affine::AffineMinOp>(loc, map, mapOperands);
    if (index->getResultTypes().size() == 1 &&
        mlir::dyn_cast<IndexType>(index->getResultTypes()[0])) {
      auto tVal = TypeValue(builder.getIndexType(), index);
...
OpGenerator affineParallelGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto op = builder.create<mlir::affine::AffineParallelOp>(
...
OpGenerator affinePrefetchGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    mlir::AffineMap map = mapCandidates[UR(mapCandidates.size())];
    auto op = builder.create<mlir::affine::AffinePrefetchOp>(
...
OpGenerator affineVectorLoadGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto op = builder.create<mlir::affine::AffineVectorLoadOp>(
...
OpGenerator affineVectorStoreGenerator() {
  return [](OpBuilder &builder, Location loc, OpRegion &parent) {
    ...
    auto op = builder.create<mlir::affine::AffineVectorStoreOp>(
