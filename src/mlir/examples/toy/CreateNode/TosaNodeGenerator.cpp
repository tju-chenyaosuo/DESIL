...
OpGenerator tosaAbsGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res_tensor =
        builder.create<mlir::tosa::AbsOp>(loc, output, input1);
...
OpGenerator tosaArgMaxGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::ArgMaxOp>(loc, output, input, axis);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaBitwiseNotGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::BitwiseNotOp>(loc, output, input);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaIdentityOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::IdentityOp>(loc, output, input1);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaLogicalLeftShiftOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res_tensor = builder.create<mlir::tosa::LogicalLeftShiftOp>(
...
OpGenerator tosaLogicalNotOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::LogicalNotOp>(loc, output, input1);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaMatMulOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::MatMulOp>(loc, outputType, a, b);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaNegateOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::NegateOp>(loc, outputType, input);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaPowOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res_tensor =
        builder.create<mlir::tosa::PowOp>(loc, z, input1, input2);
    mb->add2Pool(res_tensor);
    return true;
  };
}
...
OpGenerator tosaReciprocalOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::ReciprocalOp>(loc, output, input1);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaReverseOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::ReverseOp>(loc, output, input, axis);
    mb->add2Pool(res);
    return true;
  };
}
...
OpGenerator tosaTableOpGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<mlir::tosa::TableOp>(loc, output, input, table);
    mb->add2Pool(res);
    return true;
  };
}
