...
OpGenerator tensorCollapseShapeGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res =
        builder.create<tensor::CollapseShapeOp>(loc, source, reIdxes);
...
OpGenerator tensorEmptyGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    if (rollIdx(2)) {
      ...
      mlir::Value res = builder.create<tensor::EmptyOp>(
...
OpGenerator tensorExtractSliceGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    builder.create<tensor::ExtractSliceOp>(loc, destTy, src, offsets, sizes,
                                           strides);
    return true;
  };
}
...
OpGenerator tensorFromElementsGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = builder.create<tensor::FromElementsOp>(
...
OpGenerator tensorGenerateGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    mlir::Value res = builder.create<tensor::GenerateOp>(
...
OpGenerator tensorInsertSliceGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    auto src = srcCandidates[rollIdx(srcCandidates.size())];
    builder.create<tensor::InsertSliceOp>(loc, src, dest, offsets, sizes,
                                          strides);
    return true;
  };
}
...
OpGenerator tensorPackGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    builder.create<tensor::PackOp>(loc, src, dest, innerDimsPos, innerTiles,
...
OpGenerator tensorUnpackGenerator() {
  return [](OpBuilder &builder, Location loc, MutationBlock *mb) -> bool {
    ...
    auto dest = destCandidates[rollIdx(destCandidates.size())];
    builder.create<tensor::UnPackOp>(loc, source, dest, innerDimsPos,
